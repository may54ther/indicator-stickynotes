...
class StickyNote:
	...
	def on_motion_notify(self, widget, event):
		"""Handle motion notify event to change cursor and resize window"""
		...
		self.winMain.get_window().set_cursor(Gdk.Cursor.new_for_display(
			self.winMain.get_display(), cursor))
		self.resize_edge = edge

	def on_button_press(self, widget, event):
		"""Handle button press event to start resizing"""
	...
	def on_button_release(self, widget, event):
		"""Handle button release event to stop resizing"""
